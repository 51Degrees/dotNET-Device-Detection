...
namespace FiftyOne.Tests.Integration.DataSetBuilderTests.Lite
{
    ...
    public class V31File : FileBase
    {
        ...
        /// </summary>
        public void DataSetBuilder_FileV31_UnconfiguredCaches()
        {
        ...
        /// uses LruCaches
        /// </summary>
        public void DataSetBuilder_FileV31_DefaultCaches()
        {
        ...
        /// </summary>
        public void DataSetBuilder_FileV31_Compare()
        {
        ...
        /// contains the same data as that built using the MemoryFactory
        /// </summary>
        public void DataSetBuilder_FileV31_CompareCustomCaches()
        {
        ...
        /// not use caches and does not delete the data file
        /// </summary>
        public void DataSetBuilder_FileV31_TempFile() 
        {
