...
{
    [TestClass]
    public class V32Buffer : BufferBase
    {
        ...
        /// </summary>
        public void DataSetBuilder_BufferV32_UnconfiguredCaches()
        {
        ...
        /// uses LruCaches
        /// </summary>
        public void DataSetBuilder_BufferV32_DefaultCaches()
        {
        ...
        /// </summary>
        public void DataSetBuilder_BufferV32_Compare()
        {
        ...
        /// contains the same data as that built using the MemoryFactory
        /// </summary>
        public void DataSetBuilder_BufferV32_CompareCustomCaches()
        {
