...
namespace FiftyOne.UnitTests.Memory.Lite
{
    ...
    public class V32Array : Array
    {
        ...
        {
            base.UserAgentsMulti(File.ReadAllLines(Constants.GOOD_USERAGENTS_FILE), 60);
        }

        [TestMethod]
        public void LiteV32Array_Memory_UniqueUserAgentsSingle()
        {
            base.UserAgentsSingle(File.ReadAllLines(Constants.GOOD_USERAGENTS_FILE), 60);
        }
        ...
        {
            base.UserAgentsMulti(UserAgentGenerator.GetEnumerable(Constants.USERAGENT_COUNT, 10), 60);
        }

        [TestMethod]
        public void LiteV32Array_Memory_BadUserAgentsSingle()
        {
            base.UserAgentsSingle(UserAgentGenerator.GetEnumerable(Constants.USERAGENT_COUNT, 10), 60);
        }
    }
}
