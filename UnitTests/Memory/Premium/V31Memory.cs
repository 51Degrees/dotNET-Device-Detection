...
namespace FiftyOne.UnitTests.Memory.Premium
{
    ...
    public class V31Memory : Memory
    {
        ...
        [TestMethod]
        public void PremiumV31Memory_Memory_UniqueUserAgentsMulti()
        {
            base.UserAgentsMulti(File.ReadAllLines(Constants.GOOD_USERAGENTS_FILE), 800);
        }

        [TestMethod]
        public void PremiumV31Memory_Memory_UniqueUserAgentsSingle()
        {
            base.UserAgentsSingle(File.ReadAllLines(Constants.GOOD_USERAGENTS_FILE), 800);
        }

        [TestMethod]
        public void PremiumV31Memory_Memory_RandomUserAgentsMulti()
        {
            base.UserAgentsMulti(UserAgentGenerator.GetRandomUserAgents(), 800);
        }

        [TestMethod]
        public void PremiumV31Memory_Memory_RandomUserAgentsSingle()
        {
            base.UserAgentsSingle(UserAgentGenerator.GetRandomUserAgents(), 800);
        }
        ...
        [TestMethod]
        public void PremiumV31Memory_Memory_BadUserAgentsSingle()
        {
            base.UserAgentsSingle(UserAgentGenerator.GetBadUserAgents(), 800);
        }
    }
}
