...
namespace FiftyOne.UnitTests.MetaData.Enterprise
{
    ...
    public class V31Memory : Base
    {
        ...
        {
            _dataSet = MemoryFactory.Create(Path.Combine(Constants.ENTERPRISE_PATTERN_V31));
        }

        [TestMethod]
        public void EnterpriseV31Memory_RetrieveComponents() { base.RetrieveComponents(); }

        [TestMethod]
        public void EnterpriseV31Memory_RetrieveProperties() { base.RetrieveProperties(); }
