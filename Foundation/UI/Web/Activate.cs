...
namespace FiftyOne.Foundation.UI.Web
{
    ...
    /// to the user.
    /// </summary>
    public class Activate : BaseDataControl
    {
        #region Constants
        ...
        public override string SuccessCssClass
        {
            ...
            set { base.SuccessCssClass = value; _upload.SuccessCssClass = value; }
        }
        ...
        public override string ErrorCssClass
        {
            ...
            set { base.ErrorCssClass = value; _upload.ErrorCssClass = value; }
        }
        ...
        private void _buttonActivate_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                var result = Execute(_textBoxLicenceKey.Text);
